        ...
        <div className="bg-white rounded-xl shadow-sm mb-8">
          ...
          <div className="p-6">
            {activeTab === 'council' && (
              <div className="space-y-6">
                <div className="text-center mb-8">
                  <h2 className="text-2xl font-bold text-gray-900 mb-2">Student Council Winners</h2>
                  <p className="text-gray-600">Final results for all council positions</p>
                </div>
                            ...
                            <div key={idx} className="bg-white rounded-lg p-4 border border-gray-200">
                              <div className="flex items-center space-x-3">
                                ...
                                <div>
                                  ...
                                  <p className="text-xs text-gray-500">{person.registrationNumber}</p>
                                </div>
                              </div>
                            </div>
                          ))}
            ...
            {activeTab === 'delegates' && (
              <div className="space-y-6">
                <div className="text-center mb-8">
                  <h2 className="text-2xl font-bold text-gray-900 mb-2">Elected Delegates</h2>
                  <p className="text-gray-600">Representatives from each department</p>
                </div>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-4">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-500">{delegate.registrationNumber}</p>
                              <div className="flex space-x-2 mt-1">
                                <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                  {delegate.schoolName}
                                </span>
                                <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                  {delegate.departmentName}
                                </span>
                              </div>
                            </div>
                          </div>
                          <div className="text-right">
                            <div className="text-2xl font-bold text-green-600">{delegate.voteCount}</div>
